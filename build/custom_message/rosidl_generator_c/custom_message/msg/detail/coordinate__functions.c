...
custom_message__msg__Coordinate__create()
{
  ...
  custom_message__msg__Coordinate * msg = (custom_message__msg__Coordinate *)allocator.allocate(sizeof(custom_message__msg__Coordinate), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_message__msg__Coordinate));
  bool success = custom_message__msg__Coordinate__init(msg);
  if (!success) {
...
custom_message__msg__Coordinate__destroy(custom_message__msg__Coordinate * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    custom_message__msg__Coordinate__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
custom_message__msg__Coordinate__Sequence__init(custom_message__msg__Coordinate__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_message__msg__Coordinate * data = NULL;

  if (size) {
    data = (custom_message__msg__Coordinate *)allocator.zero_allocate(size, sizeof(custom_message__msg__Coordinate), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_message__msg__Coordinate__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        custom_message__msg__Coordinate__fini(&data[i - 1]);
      }
...
custom_message__msg__Coordinate__Sequence__fini(custom_message__msg__Coordinate__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_message__msg__Coordinate__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_message__msg__Coordinate__Sequence * array = (custom_message__msg__Coordinate__Sequence *)allocator.allocate(sizeof(custom_message__msg__Coordinate__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_message__msg__Coordinate__Sequence__init(array, size);
  if (!success) {
...
custom_message__msg__Coordinate__Sequence__destroy(custom_message__msg__Coordinate__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_message__msg__Coordinate__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_message__msg__Coordinate__Sequence__are_equal(const custom_message__msg__Coordinate__Sequence * lhs, const custom_message__msg__Coordinate__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_message__msg__Coordinate__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_message__msg__Coordinate__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_message__msg__Coordinate);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_message__msg__Coordinate * data =
      (custom_message__msg__Coordinate *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_message__msg__Coordinate__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_message__msg__Coordinate__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_message__msg__Coordinate__copy(
