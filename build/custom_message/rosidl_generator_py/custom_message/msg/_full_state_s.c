...
bool custom_message__msg__full_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_message.msg._full_state.FullState", full_classname_dest, 40) == 0);
  }
  custom_message__msg__FullState * ros_message = _ros_message;
  {  // x
  ...
  {  // delta
    ...
    assert(PyFloat_Check(field));
    ros_message->delta = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // throttle
...
PyObject * custom_message__msg__full_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_message.msg._full_state");
