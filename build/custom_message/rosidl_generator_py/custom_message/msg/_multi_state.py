...
class Metaclass_MultiState(type):
    """Metaclass of message 'MultiState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_message.msg.MultiState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__multi_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__multi_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__multi_state
...
class MultiState(metaclass=Metaclass_MultiState):
    """Message class 'MultiState'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.multiple_state = kwargs.get('multiple_state', [])
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.multiple_state != other.multiple_state:
            return False
        return True
    ...
    @builtins.property
    def multiple_state(self):
        """Message field 'multiple_state'."""
        return self._multiple_state
