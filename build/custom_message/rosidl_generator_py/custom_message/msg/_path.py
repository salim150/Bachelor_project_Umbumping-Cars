...
class Path(metaclass=Metaclass_Path):
    ...
    _fields_and_field_types = {
        'path': 'sequence<custom_message/Coordinate>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['custom_message', 'msg'], 'Coordinate')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'path' field must be a set or sequence and each value of type 'Coordinate'"
        self._path = value
