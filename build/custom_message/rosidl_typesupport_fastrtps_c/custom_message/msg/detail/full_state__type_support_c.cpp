...
#include "custom_message/msg/detail/full_state__rosidl_typesupport_fastrtps_c.h"
...
using _FullState__ros_msg_type = custom_message__msg__FullState;
...
static uint32_t _FullState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_message__msg__FullState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_message__msg__FullState;
    is_plain =
      (
...
static size_t _FullState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_message__msg__FullState(
