...
#include "custom_message/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_message/msg/detail/coordinate__functions.h"  // path

// forward declare type support functions
size_t get_serialized_size_custom_message__msg__Coordinate(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_custom_message__msg__Coordinate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_message, msg, Coordinate)();


using _Path__ros_msg_type = custom_message__msg__Path;
  ...
  // Field name: path
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_message, msg, Coordinate
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: path
  {
    ...
    if (ros_message->path.data) {
      custom_message__msg__Coordinate__Sequence__fini(&ros_message->path);
    }
    if (!custom_message__msg__Coordinate__Sequence__init(&ros_message->path, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name path
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_custom_message__msg__Coordinate(
...
static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_message__msg__Path(
  ...
  size_t current_alignment)
{
  ...
  // member: path
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_custom_message__msg__Coordinate(
  ...
  if (is_plain) {
    ...
    using DataType = custom_message__msg__Path;
    is_plain =
      (
...
static size_t _Path__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_message__msg__Path(
