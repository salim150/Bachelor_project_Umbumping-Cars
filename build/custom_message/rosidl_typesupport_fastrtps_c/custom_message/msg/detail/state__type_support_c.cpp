...
#include "custom_message/msg/detail/state__rosidl_typesupport_fastrtps_c.h"
...
using _State__ros_msg_type = custom_message__msg__State;
...
static uint32_t _State__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_message__msg__State(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_message__msg__State;
    is_plain =
      (
...
static size_t _State__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_message__msg__State(
