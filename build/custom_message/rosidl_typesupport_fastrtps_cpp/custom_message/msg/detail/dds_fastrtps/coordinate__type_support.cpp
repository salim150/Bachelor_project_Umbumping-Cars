...
#include "custom_message/msg/detail/coordinate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_message::msg::Coordinate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_message::msg::Coordinate & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_message::msg::Coordinate;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const custom_message::msg::Coordinate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_message::msg::Coordinate *>(
    untyped_ros_message);
...
{
  return &custom_message::msg::typesupport_fastrtps_cpp::_Coordinate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_message, msg, Coordinate)() {
  return &custom_message::msg::typesupport_fastrtps_cpp::_Coordinate__handle;
}
